...
function DriverPaymentTable() {
  ...
  useEffect(() => {
    const stored = JSON.parse(localStorage.getItem('driverPayments') || '[]');
    setPayments(stored);
  }, []);
  ...
  const handleEditSave = (idx) => {
    ...
    setPayments(updated);
    localStorage.setItem('driverPayments', JSON.stringify(updated));
    setEditIdx(null);
  };
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="fw-bold mb-4">Driver Payments</h2>
