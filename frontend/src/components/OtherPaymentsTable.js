...
function OtherPaymentsTable() {
  ...
  useEffect(() => {
    const stored = JSON.parse(localStorage.getItem('otherPayments') || '[]');
    setPayments(stored);
  }, []);
  ...
  const handleEditSave = (idx) => {
    ...
    setPayments(updated);
    localStorage.setItem('otherPayments', JSON.stringify(updated));
    setEditIdx(null);
  };
  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h2 className="fw-bold mb-4">Other Payments</h2>
